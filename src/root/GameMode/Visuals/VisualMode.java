...
public abstract class VisualMode implements ResourcesPath {
    ...
    public Image MenuGame = new ImageIcon(MENU_GAME).getImage();
    ...
    public Image SunFlowerImage = new ImageIcon(SUNFLOWER).getImage();
    ...
    public ImageIcon GatlingPeaCardIcon;
    public Image GatlingPeaImage;
    ...
    //Snow zombie
    public Image SnowZombieImage;
    public Image SnowZombieEatImage;
    public Image SnowZombieLostHeadImage;
    public Image SnowZombieLostHeadEatImage;
    ...
    public Dimension Menu_Dim = new Dimension(MenuGame.getWidth(null), MenuGame.getHeight(null));
    ...
    public Dimension cellSize = new Dimension(SunFlowerImage.getWidth(null), SunFlowerImage.getHeight(null));
